...
for idx, case in enumerate(eval_cases):
    ...
    results_table[idx, 4] = len(triang.triangles_lift)  # triangs in simplicial complex
    ...
    graph.set_grid_resolution(0.25, 0.25)
    n_runs_fine = 1  # reduce number of runs for finer grid
    t = (
        timeit.timeit(
            lambda graph=graph: graph.build_homotopy_augmented_graph(),
            number=n_runs_fine,
