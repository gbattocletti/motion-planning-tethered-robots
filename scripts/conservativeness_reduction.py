...
for idx, case in enumerate(eval_cases):
    ...
    results_table[idx, 7] = graph_1.compute_area()  # area of h augmented graph
    ...
    results_table[idx, 9] = graph_2.compute_area()  # area of h augmented graph
    ...
    with open(
        ...
        # Print header
        print(
            "env\tl\t|R|\tA_R\t|R'|\tA_R'\t|H_1|\tA_H_1\t|H_2|\tA_H_2",
            end="\n",
        )
